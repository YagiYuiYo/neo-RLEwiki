...
Monash IVF做冻精的费用分为两部分：采集collection fee和寄存storage fee. 采集费用一次性约AUD 500，寄存费用每半年AUD 320，以上皆为没有保险没有Medicare的全价。GP开的referrel letter因为写明了是因为gender affirming care，属于Medicare可以报销：采集费全免，寄存费减半到每半年AUD 160
